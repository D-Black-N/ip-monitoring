...
--
-- Name: events events_ip_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.events
    ADD CONSTRAINT events_ip_id_fkey FOREIGN KEY (ip_id) REFERENCES public.ips(id) ON DELETE CASCADE;
